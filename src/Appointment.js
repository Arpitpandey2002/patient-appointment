...
const Appointment = () => {
    ...
    const handleInput = (event) => {
        ...
        // dropdown data using react-select package
        // const options = [
        //     {value:"Cervix Checkup", label:"Cervix Checkup"},
        //     {value:"Heart Checkup", label:"Heart Checkup"},
    ...
    return (
        <>
            <div className="container">
                <h4 className="text text-center text-danger">Doctor Appointment Form</h4>
         ...
         />
          ...
          {/* <div  className="form-group col-lg-6 mt-2">
            ...
            <Select options={options} name={patientAppointment.appointment} onChange={handleInput}/>
          </div>
                       */}
